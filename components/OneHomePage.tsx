        ...
        <div className={`relative ${PAD} pb-12 pt-[clamp(72px,12vh,150px)]`}>
          <div className="grid gap-x-10 gap-y-12 md:grid-cols-[1.6fr_1fr_1fr_1.4fr]">
            <div className="max-w-sm">
              ...
              <p className="mt-4 text-[17px] leading-relaxed text-chrome">OneHome by LineHaul Station — a smarter way to live on the road, built exclusively for professional drivers.</p>
            ...
            <div className="flex flex-col gap-2.5">
              <div className="font-label text-[10px] uppercase tracking-[0.2em] text-[#8f8f8f]">Quick Links</div>
              {[["#core", "The Math"], ["#amenities", "Amenities"], ["#network", "Network"], ["#faq", "FAQ"]].map(([href, label]) => (
                <a key={href} href={href} className="w-fit font-label text-[13px] uppercase tracking-[0.12em] text-chrome transition-colors hover:text-fuel">{label}</a>
              ))}
            </div>
            <div className="flex flex-col gap-2.5">
              <div className="font-label text-[10px] uppercase tracking-[0.2em] text-[#8f8f8f]">Explore</div>
              <a href="/" className="w-fit font-label text-[13px] uppercase tracking-[0.12em] text-chrome transition-colors hover:text-fuel">Home</a>
              <a href="/carriers" className="w-fit font-label text-[13px] uppercase tracking-[0.12em] text-chrome transition-colors hover:text-fuel">Carriers</a>
              <a href="/leadership" className="w-fit font-label text-[13px] uppercase tracking-[0.12em] text-chrome transition-colors hover:text-fuel">Leadership</a>
              <a href="#join-free" className="w-fit font-label text-[13px] uppercase tracking-[0.12em] text-fuel transition-colors hover:brightness-125">Join Free</a>
            </div>
            <div className="max-w-sm">
              <div className="font-label text-[10px] uppercase tracking-[0.2em] text-[#8f8f8f]">Newsletter</div>
              <p className="mb-3 mt-2 text-[16px] leading-relaxed text-chrome">Launch news and West Memphis founding-rate updates.</p>
