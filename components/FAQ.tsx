        ...
        return (
          <div key={i}>
            ...
            >
              ...
              <span className="flex-1 font-display text-[clamp(21px,2.53vw,30px)] font-extrabold uppercase leading-tight tracking-[-0.01em] text-white">
                {item.q}
              </span>
              <span
                className="grid h-8 w-8 flex-none place-items-center rounded-full border border-chrome/25 text-[21px] text-white transition-transform duration-300"
            ...
            >
              <div className="overflow-hidden">
                <p className="max-w-[60ch] pb-7 pl-10 text-[clamp(18px,1.95vw,21px)] leading-relaxed text-[#d8d8d8]">
                  {item.a}
                </p>
              </div>
            </div>
