...
export const PHOTOS = {
  terminalDay: "/assets/photos/terminal-day.jpg",
  terminalDusk: "/assets/photos/terminal-dusk.jpg",
  terminalRendering: "/assets/photos/terminal-rendering.jpg",
  road: "/assets/photos/road-sunset.jpg",
  clubLounge: "/assets/photos/club-lounge.jpg",
  clubShop: "/assets/photos/club-shop.jpg",
};
...
export type Audience = {
  ...
  amenities?: {
    ...
    headline: string;
    intro: string;
    tiles: { title: string; blurb: string }[];
    footnote: string;
  };
...
export const audiences: Record<AudienceKey, Audience> = {
  drivers: {
    ...
    amenities: {
      ...
      tiles: [
        { title: "Member's Grill", blurb: "Hot meals, real cooking — no truck-stop microwave." },
        { title: "Sky Deck", blurb: "Open-air lounge to decompress after the haul." },
        { title: "Digital Den", blurb: "Fast Wi-Fi, screens, quiet desks for the paperwork." },
        { title: "Fitness Studio", blurb: "Stay road-strong with real equipment." },
        { title: "Laundry & More", blurb: "Fresh clothes without losing a day." },
        { title: "Gear Shop", blurb: "Parts, supplies, and road essentials on site." },
        { title: "Resort Pool & Spa", blurb: "Recover like the miles are worth it." },
        { title: "Camp K9", blurb: "Your co-pilot gets cared for too." },
      ],
